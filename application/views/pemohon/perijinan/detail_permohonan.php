            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-footer">
                        <button type="submit" id="kirimBerkasKembali" name="kirimBerkasKembali" class="btn btn-primary float-right">Ajukan Perpanjang SIP</button>
                    </div>
                    <!-- /.card-footer -->
                </div>
                <?php echo form_close(); ?>
...
<?php $this->load->view('pemohon/perijinan/detail_berkas') ?>