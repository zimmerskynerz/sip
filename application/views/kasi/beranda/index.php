<?php $this->load->view('kasi/beranda/notif') ?>
<br>
                ...
                <div class="info-box bg-info">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="progress-description">
                            <a href="<?= base_url('kasi/pemohon_rekomendasi/baru') ?>" style="color: aliceblue;">Selengkapnya >>></a>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-md-6 col-sm-6 col-12">
                <div class="info-box bg-primary">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="progress-description">
                            <a href="<?= base_url('kasi/pemohon_rekomendasi/perpanjang') ?>" style="color: aliceblue;">Selengkapnya >>></a>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
