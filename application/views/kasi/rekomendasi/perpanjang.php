            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Rekomendasi Perpanjang</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <?php foreach ($data_perpanjang as $Data_perpanjang) : ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?= base_url('kasi/pemohon_rekomendasi/detail_berkas/' . $Data_perpanjang->id_user . '') ?>" class="bs-tooltip" data-placement="top" title="" data-original-title="Detail">
