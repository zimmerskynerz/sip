                                ...
                                <?php foreach ($data_validasi as $Data_validasi) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a id="detail_sip" href="javascript:void(0);" class="bs-tooltip" data-toggle="modal" data-target="#sip_detail" data-placement="top" title="" data-original-title="Detail" 
                                            data-nm_lengkap="<?= $Data_validasi->nm_lengkap ?>" 
                                            data-id_sip="<?= $Data_validasi->id_sip ?>" 
                                            data-no_str="<?= $Data_validasi->no_str ?>"
                                            data-no_rekomendasi="00<?= $Data_validasi->id_rekomendasi ?>/SR.<?= $Data_validasi->singkatan ?>/<?= date('Y', strtotime($Data_validasi->tgl_daftar)) ?>/KUDUS-JT12"
...
<?php $this->load->view('kasi/validasi/detail_sip')?>